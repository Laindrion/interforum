...
$(document).ready(function () {
  ...
  **********************/
  ...
  const accordionCloseBtn = document.querySelectorAll('.accardion-close');
  ...
  accordionCloseBtn.forEach((btn, index) => {
    btn.addEventListener('click', () => {
      accordionTitles[index].classList.remove('accardion-active')
    })
  })
  ...
  **********************/
  ...
  if (eventsSection) {
    ...
    function rotate(e) {
      const cardItem = this.querySelector(".events__item");
  ...
  /**********************
    **********************
        About Uzbekistan Buttons
    *********************
  **********************/

  let about_uzb_btns = document.querySelectorAll(".uzbekistan__about-btn");
  let about_uzb_items = document.querySelectorAll(".uzbekistan__about-item");
  let about_uzb_content = document.querySelectorAll(".uzbekistan__about-accardion");
  ...
  about_uzb_btns.forEach((btn, index) => {
    btn.addEventListener("click", () => {
      ...
      if (btn.classList.contains("active")) {
        ...
        about_uzb_items[index].classList.remove("active");
      } else {
        const btnActive = document.querySelectorAll(".uzbekistan__about-btn.active");
        const accardionActive = document.querySelectorAll(".uzbekistan__about-accardion.active");
        const itemsActive = document.querySelectorAll(".uzbekistan__about-item.active");
        btnActive.forEach((btnActive, btnActiveIndex) => {
          btnActive.classList.remove("active");
          accardionActive[btnActiveIndex].classList.remove("active");
          itemsActive[btnActiveIndex].classList.remove("active")
        })

        btn.classList.add("active")
        about_uzb_content[index].classList.add("active");
        about_uzb_items[index].classList.add("active");
      }
    })
  })
